...
#' The tidyomics logo, using ASCII or Unicode characters
#'
...
tidyomics_logo <- function(unicode = cli::is_utf8_output()) {
  logo <- c(
    "0 __  _    __   1    2           3  4 ",
  ...
  structure(cli::col_blue(logo), class = "tidyomics_logo")
}

#' @export

print.tidyomics_logo <- function(x, ...) {
  cat(x, ..., sep = "\n")
  invisible(x)
}
